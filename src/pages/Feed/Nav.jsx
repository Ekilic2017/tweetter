...
<div key={key} className='flex items-center gap-3 text-2xl md:text-xl
p-3 cursor-pointer rounded-lg transition hover:bg-[#505050b7] 
...
<p className='max-md:hidden'>{user.displayName}</p>
        ...
        md:text-[15px] bg-zinc-700 rounded
        text-xl transition hover:bg-zinc-900'>
          <BiSolidDoorOpen/>
